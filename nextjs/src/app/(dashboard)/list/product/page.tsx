    ...
    <div>
      <div className="bg-white p-4 rounded-md flex-1 m-4 mt-0">
        ...
        <div className="flex items-center justify-between">
          <h1 className="hidden md:block text-lg font-semibold">All Product</h1>
          <div className="flex flex-col md:flex-row items-center gap-4 w-full md:w-auto">
            ...
            <div className="flex items-center gap-4 self-end">
              ...
              <div>
                <Link href={"/list/product/createbook"}>
                  <button className="w-8 h-8 flex items-center justify-center rounded-full bg-lamaYellow">
              ...
              <tbody>
                {BookData.map((book, index) => (
                  ...
                  >
                    ...
                    <td className="hidden md:table-cell">{book.name}</td>
                    <td className="hidden md:table-cell">{book.author}</td>
                    <td className="hidden md:table-cell">{book.category}</td>
                    <td className="hidden md:table-cell">{book.price}</td>
                    <td className="hidden md:table-cell">{book.quantity}</td>
                    <td className="hidden md:table-cell">{book.status}</td>
                    <td>
                      <div className="flex items-center gap-2">
                        <Link href={`/list/product/${book.isbn}`}>
