...
<div className="flex items-start justify-center w-full p-0">
  <img
    src="https://theme.hstatic.net/200000343865/1001052087/14/ms_banner_img2.jpg?v=1883"
    alt="Banner"
  ...
  />
      ...
      {/* Product Section */}
      <div>
        <h2 className='text-2xl font-semibold text-center text-black mb-6 mt-4'>Văn Học Việt Nam</h2>
        <div className="flex flex-wrap justify-center gap-6">
          ...
          <div className="card card-compact bg-white text-black w-full sm:w-64 md:w-48 lg:w-64 shadow-xl">
            ...
            <div className="card-body">
              ...
              <div className="card-actions justify-end">
                <Link href="/ProductDetail/978-604-2-36241-0">
          ...
          <div className="card card-compact bg-white text-black w-full sm:w-64 md:w-48 lg:w-64 shadow-xl">
            ...
            <div className="card-body">
              ...
              <p>Văn học Việt Nam</p>
              <div className="card-actions justify-end">
                <Link href="/ProductDetail/978-604-2-36241-2">
          ...
          <div className="card card-compact bg-white text-black w-full sm:w-64 md:w-48 lg:w-64 shadow-xl">
            ...
            <div className="card-body">
              ...
              <p>Văn học Việt Nam</p>
              <div className="card-actions justify-end">
              <Link href="/ProductDetail/978-604-2-13489-7  ">
              <button className="btn btn-error">Xem Ngay</button></Link>
              </div>
            </div>
          </div>
          ...
          <div className="card card-compact bg-white text-black w-full sm:w-64 md:w-48 lg:w-64 shadow-xl">
            ...
            <div className="card-body">
              ...
              <Link href="/ProductDetail/978-604-2-22633-2  ">
              <button className="btn btn-error">Xem Ngay</button></Link>
              </div>
            </div>
          </div>
        ...
        <div className="flex flex-wrap justify-center gap-6">
          ...
          <div className="card card-compact bg-white text-black w-full sm:w-64 md:w-48 lg:w-64 shadow-xl">
            ...
            <div className="card-body">
              ...
              <p>Manga - Comic</p>
              <div className="card-actions justify-end">
              <Link href="/ProductDetail/6242203330001 ">
              <button className="btn btn-error">Xem Ngay</button></Link>
              </div>
            </div>
          </div>
          ...
          <div className="card card-compact bg-white text-black w-full sm:w-64 md:w-48 lg:w-64 shadow-xl">
            ...
            <div className="card-body">
              ...
              <p>Manga - Comic</p>
              <div className="card-actions justify-end">
              <Link href="/ProductDetail/6242200610001">
              <button className="btn btn-error">Xem Ngay</button></Link>
              </div>
            </div>
          </div>
          ...
          <div className="card card-compact bg-white text-black w-full sm:w-64 md:w-48 lg:w-64 shadow-xl">
            ...
            <div className="card-body">
              ...
              <p>Manga - Comic</p>
              <div className="card-actions justify-end">
              <Link href="/ProductDetail/978-604-2-34974-1  ">
              <button className="btn btn-error">Xem Ngay</button></Link>
              </div>
            </div>
          </div>
          ...
          <div className="card card-compact bg-white text-black w-full sm:w-64 md:w-48 lg:w-64 shadow-xl">
            ...
            <div className="card-body">
              <h2 className="card-title">Diệt Quỷ</h2>
              <p>Manga - Comic</p>
              <div className="card-actions justify-end">
              <Link href="/ProductDetail/6242213630001 ">
              <button className="btn btn-error">Xem Ngay</button></Link>
              </div>
            </div>
          </div>
      ...
      <div>
        <div className="relative flex items-center justify-center text-white text-center px-4">
          <img
            src="https://theme.hstatic.net/200000343865/1001052087/14/banner_home_pro_5.jpg?v=1883"
            alt="Banner"
            className="rounded-full w-full max-w-6xl h-44"
          />
          <div className="absolute inset-0 flex items-center justify-center bg-opacity-50 p-6">
